function pirates(input) {
    ...
    while (line !== 'End') {
        ...
        switch (command) {
            case 'Plunder': plunder(line); break;
            case 'Prosper': prosper(line); break;
        }
    ...
    if (citiesCount > 0) {
        ...
        for (let city of sorted) {
            ...
            console.log(`${cityName} -> Population: ${cityPopulation} citizens, Gold: ${cityGold} kg`);
        }
    } else {
    ...
    function plunder(line) {
        ...
        if (list.hasOwnProperty(cityName)) {
            ...
            console.log(`${cityName} plundered! ${goldStolled} gold stolen, ${killedPeople} citizens killed.`)
    ...
    function prosper(line) {
        ...
        console.log(`${goldToAdd} gold added to the city treasury. ${cityName} now has ${list[cityName][1]} gold.`);
      return list;
    }
